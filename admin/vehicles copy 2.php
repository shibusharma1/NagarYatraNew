...
?>
<?php if (isset($_SESSION['vehicle_added']) || isset($_SESSION['vehicle_edited']) || isset($_SESSION['vehicle_deleted'])): ?>
  ...
  <script>
    ...
    <?php if (isset($_SESSION['vehicle_added'])): ?>
      Toast.fire({
        icon: "success",
        title: "Vehicle Added Successfully"
      });
      <?php unset($_SESSION['vehicle_added']); endif; ?>

    <?php if (isset($_SESSION['vehicle_edited'])): ?>
      Toast.fire({
        icon: "success",
        title: "Vehicle Updated Successfully"
      });
      <?php unset($_SESSION['vehicle_edited']); endif; ?>

    <?php if (isset($_SESSION['vehicle_deleted'])): ?>
      Toast.fire({
        icon: "success",
        title: "Vehicle Deleted Successfully"
      });
      <?php unset($_SESSION['vehicle_deleted']); endif; ?>
  </script>
<?php endif; ?>
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
          ...
          <td>
            ...
            <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $row['id']; ?>);" class="action-btn">
...
<?php if (isset($_SESSION['vehicle_deleted'])): ?>
  ...
  <?php unset($_SESSION['vehicle_deleted']); ?>
<?php endif; ?>
