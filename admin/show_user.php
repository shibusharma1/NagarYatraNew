...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT u.name, u.email, u.phone, u.gender, u.dob, 
...
<div class="container">
    ...
    <div class="user-container">
        <div class="user-image">
            <img src="<?php echo htmlspecialchars($row['user_image']); ?>" alt="User Image">
        ...
        <div class="user-info">
            ...
            <div class="info-item">
                <i class="fas fa-venus-mars"></i> <strong>Gender:</strong> <?php echo htmlspecialchars($row['gender']); ?>
            </div>
            ...
            <div class="info-item">
                <i class="fas fa-map-marker-alt"></i> <strong>Address:</strong> <?php echo htmlspecialchars($row['address']); ?>
            </div>

            <div class="info-item">
                <i class="fas fa-id-card"></i> <strong>DL Number:</strong> <?php echo htmlspecialchars($row['dl_number']); ?>
            </div>

            <div class="info-item">
                <i class="fas fa-calendar-check"></i> <strong>DL Expiry Date:</strong> <?php echo htmlspecialchars($row['dl_expiry_date']); ?>
            </div>

            <div class="info-item">
                <i class="fas fa-shield-alt"></i> <strong>Verification Status:</strong> <?php echo $verification_status; ?>
            </div>
        </div>
    </div>
