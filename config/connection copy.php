...
$sql1 = "INSERT IGNORE INTO user (id, name, role, email, password, phone, status, cancel_status, dob, gender, image, experience, address, dl_number, dl_image, dl_expiry_date, vehicle_id, otp, otp_expiry, is_verified) 
        VALUES (1, 'NagarYatra User', 0, 'user@gmail.com', '$hashedpassword', 9876543210, 1, 0, '1990-05-15', 'MALE', NULL, NULL, 'New York, USA', NULL, NULL, NULL, NULL, '123456', NOW() + INTERVAL 5 MINUTE, 1)";

$sql2 = "INSERT IGNORE INTO user (id, name, role, email, password, phone, status, cancel_status, dob, gender, image, experience, address, dl_number, dl_image, dl_expiry_date, vehicle_id, otp, otp_expiry, is_verified) 
        VALUES (2, 'NagarYatra Driver', 1, 'driver@gmail.com', '$hashedpassword', 9876543211, 1, 0, '1988-09-20', 'FEMALE', NULL, '5 years of experience', 'Los Angeles, USA', 'DL123456789', NULL, '2030-12-31', 1, '654321', NOW() + INTERVAL 5 MINUTE, 1)";
...
//     remarks TEXT NULL, -- The user can write his view regarding the specific ride
...
// $sql = "INSERT IGNORE INTO feedback (id, subject, message, user_id) 
//         VALUES 
//         (1, 'Great Service', 'The ride was smooth and the driver was very professional.', 2), 
//         (2, 'Punctuality Issue', 'The driver arrived 10 minutes late, but the ride was good overall.', 5), 
//         (3, 'Excellent Experience', 'Loved the experience! The vehicle was clean and comfortable.', 3), 
//         (4, 'Payment Issue', 'Faced an issue with online payment, but customer support resolved it.', 7), 
//         (5, 'Friendly Driver', 'The driver was very friendly and helpful during the ride.', 4), 
//         (6, 'Unclean Vehicle', 'The vehicle was not properly cleaned before the ride.', 6), 
//         (7, 'Smooth Booking Process', 'Booking the ride was super easy and hassle-free.', 8), 
//         (8, 'Safety Concern', 'The driver was driving a bit fast, but overall it was safe.', 9), 
//         (9, 'Affordable Pricing', 'Really happy with the pricing, very affordable and worth it.', 10), 
//         (10, 'Good Customer Support', 'Had an issue with my ride, but the support team resolved it quickly.', 1)";
