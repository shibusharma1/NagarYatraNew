  ...
  <div class="container mt-4">
    ...
    <form action="" method="post" onsubmit="return prepareBooking();">
      ...
      <div class="input-group mb-3">
        ...
        <button type="button" class="btn btn-theme" onclick="setpickup()"
          style="background-color:rgb(31, 56, 88);color:white;border-right:2px solid white;border-radius:8px;">Search</button>
