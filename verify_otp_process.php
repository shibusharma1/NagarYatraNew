...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user) {
        ...
        if ($entered_otp == $stored_otp && strtotime($otp_expiry) >= time()) {
            ...
            $update = $conn->prepare("UPDATE user SET is_verified = 1, otp = NULL, otp_expiry = NULL WHERE email = ?");
            ...
            try {
                ...
                $mail->Body = "
                    <div style='font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 10px;'>
                        ...
                        <p>Congratulations! Your account has been successfully created on <b>NagarYatra</b>.</p>
                        ...
                        <div style='text-align: center; margin: 20px 0;'>
                            <a href='http://localhost/NagarYatra/login' style='background: #3498db; color: white; padding: 12px 20px; border-radius: 5px; text-decoration: none; font-weight: bold;'>Login to Your Account</a>
                        </div>
                ...
                $mail->AltBody = "Welcome to NagarYatra, $name! Your account has been successfully created. You can now log in using your email: $email. Visit https://www.NagarYatra.com/login to access your account.";
                $mail->send();
